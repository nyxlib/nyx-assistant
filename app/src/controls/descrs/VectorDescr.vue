        ...
        <div class="col-md-4">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    Vector <i class="bi bi-question-circle-fill" :title="`Id: ${vector.id}, Rank: ${vector.rank}`" v-tooltip></i>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-sm" type="text" id="F7166B34" placeholder="Label" v-model="vector.label" />
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-sm" type="text" id="F09714F1" placeholder="Group" v-model="vector.group" />
                            </div>
